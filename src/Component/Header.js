    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-[#0F172A]/90 backdrop-blur-md">
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <a href="index.html" className="text-sm font-medium text-white hover:text-primary transition-colors">Home</a>
          <a href="/community" className="text-sm font-medium text-white hover:text-primary transition-colors">Community</a>
          <a href="experts.html" className="text-sm font-medium text-white hover:text-primary transition-colors">Experts</a>
          <a href="destinations.html" className="text-sm font-medium text-white hover:text-primary transition-colors">Destinations</a>
          <a href="about.html" className="text-sm font-medium text-white hover:text-primary transition-colors">About</a>
        </nav>
      ...
      <div className="md:hidden border-t border-white/10 bg-[#0F172A]/95 backdrop-blur-md mob-menu hidden">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex flex-col gap-4">
            <a href="index.html" className="flex items-center gap-2 rounded-md px-3 py-2 text-white hover:bg-white/10">Home</a>
            <a href="community.html" className="flex items-center gap-2 rounded-md px-3 py-2 text-white hover:bg-white/10">Community</a>
            <a href="experts.html" className="flex items-center gap-2 rounded-md px-3 py-2 text-white hover:bg-white/10">Experts</a>
            <a href="destinations.html" className="flex items-center gap-2 rounded-md px-3 py-2 text-white hover:bg-white/10">Destinations</a>
            <a href="about.html" className="flex items-center gap-2 rounded-md px-3 py-2 text-white hover:bg-white/10">About</a>
